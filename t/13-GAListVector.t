...
# it must be dereferenced first.
{
	...
	ok( $genotype->getLength() == 3, "Check that individuals in the population have the correct length" );
}
...
{
	 my $genotype = ListVector->new([ [qw/red blue green/], [qw/big medium small/], [qw/very_fat fat fit thin very_thin/]]);
	
	 $genotype->setGen( 0, "red" );
	 $genotype->setGen( 1, "big" );
	 $genotype->setGen( 2, "fit" );
...
# evolve: example that works.
{
	...
	#rint "Score of fittest:", $ind->getScore(), "\n";
}
